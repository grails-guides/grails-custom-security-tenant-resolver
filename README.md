...
This repository contains the worked sample app for the [Custom Tenant Resolver by Current Logged in User](https://grails.apache.org/guides/grails-custom-security-tenant-resolver/4/guide/index.html) guide on the Apache Grails site.
